...
public class PlayInsideZoneBlock : BaseActionBlock<PlayInsideZoneCommand, PlayInsideZoneBlock>
{
    ...
    public override PlayInsideZoneCommand GetCommand(Context context)
    {
