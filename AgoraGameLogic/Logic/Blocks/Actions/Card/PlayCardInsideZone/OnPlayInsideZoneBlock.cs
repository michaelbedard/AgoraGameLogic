...
public class OnPlayInsideZoneBlock : BaseEventBlock
{
    public OnPlayInsideZoneBlock(BlockDefinition definition, GameData gameData) : base(definition, gameData)
    {
    ...
    protected override async Task TriggerAsync(Context context, object[] args, Scope? scope)
    {
        ...
        context.AddOrUpdate("Zone", ref args[2]);
