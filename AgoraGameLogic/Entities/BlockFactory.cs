...
{
    public static T[] CreateArray<T>(BlockDefinition[] blockDefinitions, GameData gameData) where T : BlockBase
    {
    ...
    public static T[] CreateArray<T>(JArray blockArray, GameData gameData) where T : BlockBase
    {
        var blocks = new List<T>();
    ...
    public static T Create<T>(JToken blockToken, GameData gameData) where T : BlockBase
    {
        var blockDefinition = BlockDefinition.Parse(blockToken);
        return Create<T>(blockDefinition, gameData);
    }
    
    public static T Create<T>(BlockDefinition blockDefinition, GameData gameData) where T : BlockBase
    {
        var block = Create(blockDefinition, gameData);
    ...
    public static BlockBase Create(BlockDefinition blockDefinition, GameData gameData)
    {
        BlockBase block;
