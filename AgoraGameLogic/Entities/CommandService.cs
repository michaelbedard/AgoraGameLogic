...
public abstract class CommandService<TCommand> : CommandService where TCommand : CommandBase
{
    ...
    public void FilterActions(TurnBlockBlockBase turnBlock, ScopeType scopeType, GameModule player)
    {
        foreach (var commandStore in CommandStoresByPlayerName.Values)
        {
