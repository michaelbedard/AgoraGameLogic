...
public class DescriptionService
{
        ...
        foreach (var descriptionJToken in descriptionJArray)
        {
            ...
            else
            {
                try
                {
                    ...
                    {
                        var valueBlock = BlockFactory.Create<BaseValueBlock>(descriptionJToken, gameData);
    ...
    public Dictionary<string, DescriptionDto[]> GetDescriptionDtos(Context globalContext)
    {
    ...
    private string ResolveDescription(List<object> segments, Context context)
    {
        ...
        foreach (var segment in segments)
        {
            ...
            else if (segment is BaseValueBlock valueBlock)
            {
